...
from app.routers import auth, companies, counterparties, dashboard, equipment, ingredients, packaging, production, products, public, recipes, sales, surveillance, techpanel, users
